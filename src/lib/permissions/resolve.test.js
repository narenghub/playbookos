...
test('T11 — super_admin holds all 224 non-cron features (and no crons)', async () => {
  ...
  assert.equal(allowedNonCron, 224); // +5 Content Studio (Part 3) +1 golfnex.content.publish_post (mcp_tool)
